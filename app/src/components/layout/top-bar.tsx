...
export function TopBar({
  ...
  return (
    <header className="h-12 pl-20 pr-4 border-b border-coco-border-subtle/50 flex items-center justify-between bg-coco-bg-primary backdrop-blur-sm relative">
      {/* Drag region as background layer for window dragging */}
      ...
      {onCommandPalette && (
        <button
          ...
          className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2 px-3 py-1.5 w-[280px] bg-coco-bg-tertiary hover:bg-coco-bg-inset border border-coco-border-default hover:border-coco-border-strong rounded-lg transition-all relative z-10 group shadow-sm"
        >
